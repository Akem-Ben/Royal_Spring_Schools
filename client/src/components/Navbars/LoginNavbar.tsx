...
export const LoginNavbar: React.FC = () => {
  ...
  //     <section
  //       className={`flex flex-col md:flex-row justify-between items-center pl-[350px] pb-[10px] pt-[10px] pr-[30px] shadow-lg animate__animated animate__backInDown`}
  //     >
  //       <div className="flex flex-col md:flex-row gap-4 md:gap-10 mt-4 md:mt-0 text-white">
  //         <a href="/">
